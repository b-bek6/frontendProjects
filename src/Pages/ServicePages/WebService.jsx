    ...
    return (
                    ...
                    >
                        {/* <div className='h1 leading-relaxed'>
                            <p className=''>
                                ...
                                Website
                                <div className=' body-2'>In Codniv, we provide all the services from business requirement study, interface design to convert the solutions to digital, portable platforms through android and iOS apps with the aim of expanding further by creating other possible business potentials. We mostly use React Native to build mobile applications with latest technologies maintaining the maximum quality.</div>
                            </p>
                        </div> */}
                        <Heading
                            title={"Website"}
        ...
        >
            <div className='relative container '>
                <div className='grid gap-10 uppercase justify-between grid-flow-col'>
